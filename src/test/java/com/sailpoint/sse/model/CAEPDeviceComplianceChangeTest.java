...
public class CAEPDeviceComplianceChangeTest {
    ...
    @Test
    public void Figure12() throws ParseException, SIValidationException, ValidationException {
        ...
        reasonAdmin.put("en", "Location Policy Violation: C076E8A3");
        JSONObject reasonUser = new JSONObject();
        reasonUser.put("en", "Device is no longer in a trusted location.");
